var controlador = 'seccion/fundador/';
jQuery(document).ready( function() {
    nuevo();
    estado();
    
    $('#guardar').click(function(){
        $('#txt_fun_cuerpo').val($('#editable_txt_fun_cuerpo').html());
        $('#txt_fun_datos_interes').val($('#editable_txt_fun_datos_interes').html());
    });
