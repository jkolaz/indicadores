var controlador = 'seccion/vocacional/';
jQuery(document).ready( function() {
    nuevo();
    estado();
    
    $('#guardar').click(function(){
        $('#txt_voc_descripcion').val($('#editable_txt_voc_descripcion').html());
        $('#txt_voc_descripcion_2').val($('#editable_txt_voc_descripcion_2').html());
    });
...
function estado(){
    $('.icono').click(function(){
        ...
        var id = $(this).attr('id_vocacional');
        $.ajax({
            type: "POST",
            cache: false,
            dataType: "json",
