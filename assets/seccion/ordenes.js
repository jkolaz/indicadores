var controlador = 'seccion/ordenes/';
jQuery(document).ready( function() {
    nuevo();
    estado();
    
    $('#guardar').click(function(){
        $('#txt_ord_descripcion').val($('#editable_txt_ord_descripcion').html());
        $('#txt_ord_descripcion_2').val($('#editable_txt_ord_descripcion_2').html());
    });
